...
class Student(models.Model):
    ...
    next_test_registered = models.BooleanField(default=False,verbose_name="Student registered for next test?") 
...
class Contact(models.Model):
    ...
    preffered_mode = models.CharField(max_length=20, blank=True)
