            ...
            <Styles>
                <div className="header row no-gutters align-items-center" style={{ color: "white" }}>
                    ...
                    <div className="col-md-auto px-3 ml-auto text-center">
                        <NavLink to="/student/answerkey" style={{ textDecoration: "none" }}>
                    ...
                    <div className="col-md-auto px-3 text-center">
                        <NavLink to="/student/analysis" style={{ textDecoration: "none" }}>
                    ...
                    <div className="col-md-auto px-3 text-center">
                        <NavLink to="/student/studyplan" style={{ textDecoration: "none" }}>
                            <Button className={this.props.studyplan ? "clicked" : "unclicked"} >
                                STUDY PLAN
                            </Button>
                        </NavLink>
                    </div>
